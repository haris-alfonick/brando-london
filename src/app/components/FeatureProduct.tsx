              ...
              <div className="grid grid-cols-12 gap-x-7 md:gap-y-0 gap-y-3">
                <div className="md:col-span-3 col-span-6 group flex w-full flex-col self-center overflow-hidden">
                  <div className="relative">
                    ...
                    <FontAwesomeIcon
                      icon={faHeart}
                      className="absolute top-2 right-2 text-[22px]"
                    />
                  </div>
                  <div className="py-3">
                    ...
                    <p className="leading-5 py-1 pb-3 pr-4 text-base">
                      Edward Cafe Racer Black Leather Jacket
                    </p>
                    <Link
                      href="#"
                      className="hover:border-white/40 flex items-center justify-center bg-[#020202] px-5 py-2 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300"
                    >
