						...
						<TabsContent value="Men">
							<div className="grid grid-cols-12 gap-x-7 px-5">
								<div className=" col-span-3 group flex w-full flex-col overflow-hidden bg-white">
									<Link className="relative flex h-[21rem] w-full overflow-hidden after:absolute after:top-0 after:bg-black after:content-{} after:opacity-0 after:w-full after:h-full group-hover:after:opacity-20" href="#">
										<Image
