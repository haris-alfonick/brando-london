  ...
  return (
    <>
      <div className='relative overflow-hidden'>
        ...
        <div className='bgMobile max-lg:bg-[#efefed] absolute max-lg:static h-fit bottom-0 top-0 left-0 right-0 m-auto lg:max-w-[700px] max-w-full lg:py-0 sm:py-40 max-sm:px-4 py-20 max-[425px]:py-14  md:bg-none bg-no-repeat bg-cover bg-center sm:px-0 px-1.5 text-center [&>h1]:text-[#282828] sm:[&>h1]:text-[42px] [&>h1]:text-[28px] [&>h1]:leading-tight [&>h1]:font-bold [&>h1]:uppercase [&>p]:font-semibold [&>p]:text-[#5f5f5f] [&>p]:py-5 [&>p]:pb-8 [&>p]:leading-6 sm:[&>p]:w-[415px] [&>p]:w-full [&>p]:m-auto [&>p]:text-lg [&_button]:cursor:pointer sm:[&_button]:w-44 [&_button]:w-32 sm:[&_button]:text-lg [&_button]:py-2.5 [&_button]:rounded-md'>
          <h1>
