            ...
            <div className='col-span-12 lg:col-span-8'>
              <div className='border border-gray-300 rounded-lg p-6'>
                ...
                <div className='grid grid-cols-12 py-4 px-4 items-center border-b gap-x-5'>
                  <div className='max-[485px]:col-span-12 col-span-6 sm:col-span-6 flex sm:items-center items-left gap-4 sm:flex-row'>
                  ...
                  <div className='max-[485px]:col-span-4 col-span-2 sm:col-span-2 text-center max-[485px]:flex-row flex-col '>
                    <p className='text-gray-700 text-sm'>$687.00</p>
                  </div>
                  <div className='max-[485px]:col-span-4 col-span-2 sm:col-span-2 text-center max-[640px]:item-right'>
                    <div className='flex items-center justify-center gap-2'>
                      <p>Counter</p>
                    </div>
                  </div>
                  <div className='max-[485px]:col-span-4 col-span-2 sm:col-span-2 text-right'>
                    <p className='text-gray-700 text-sm'>$687.00</p>
                  </div>
                </div>
