...
const TableDemo = () => {
  return (
    ...
    <>
      ...
      <div className="grid grid-col-span-9 container pt-10 pl-40">
        <div className="grid grid-cols-4 gap-4 py-4  mx-auto px-2 border border-black-600 ...">
        ...
        <div className="px-5 pb-5 grid-col-span-3 pt-4 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
