  ...
  return (
    <>
      ...
      <div className='container mx-auto'>
        <div className='grid grid-cols-12 pt-10 pl-24 py-4  mx-auto px-2 border border-black-600 '>
          ...
          <div className='col-span-4'>
            <div className='px-5 pb-5 grid grid-cols-2 gap-2 pt-4 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
              ...
              <div>
                <p className='text text-gray-900 dark:text-white pt-3'>
                  Sub-total
                </p>
              </div>
              <div>
              ...
              <div>
                <p className='text text-gray-900 dark:text-white border-t-2'>
                  Total
                </p>
              </div>
              <div>
            ...
            <div className='pt-4 pb-4 container'>
              <div className='pt-4 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
                <div className='px-5 pb-5'>
                  <h5 className='text-xl font-semibold tracking-tight text-gray-900 dark:text-white border-b-2'>
                    Coupon Code
                  </h5>
